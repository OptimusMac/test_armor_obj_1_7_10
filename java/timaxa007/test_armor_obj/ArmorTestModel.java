...
public class ArmorTestModel extends ArmorCustomModel {
	...
	model = AdvancedModelLoader.loadModel(new ResourceLocation(TestArmorObjMOD.MODID, "model/armor/armor_plane.obj"))
	;
	public static final ResourceLocation
	//texture = new ResourceLocation(TestArmorObjMOD.MODID, "textures/model/armor/armor_plane.png"),
	texture_glass = new ResourceLocation("minecraft", "textures/blocks/glass_white.png"),
